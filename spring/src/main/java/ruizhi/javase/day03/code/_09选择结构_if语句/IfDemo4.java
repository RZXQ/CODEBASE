 ...
 *
 * 什么时候if语句实现不能用三元改进呢?
 * 	a.当if语句控制的操作是一个输出语句的时候就不能
 * 	b. 为什么呢? 因为三元运算符是一个运算符, 运算符操作完毕就应该有一个结果, 而不是一个输出
 * </pre>
 */
class IfDemo4 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 用三元改进: 这种改进是错误的. String s = (x % 2 == 0) ?
		 * System.out.println("100是一个偶数");:System.out.println("100是一个奇数");
		 *
		 * 但是可以用这种方法: int a = 10; String s = a == 10 ? "Hello" : "World!";
