...
//
// Border Color: Utilities for controlling the color of an element's borders.
// 1. Setting the border color: Control the border color of an element using the border-{color} utilities.
// 2. Changing the opacity: Control the opacity of an element’s border color using the color opacity modifier. You can use any value defined in your opacity scale, or use arbitrary values if you need to deviate from your design tokens.
// 3. Individual sides: Use the border-{side}-{color} utilities to set the border color for one side of an element.
// 4. Horizontal and vertical sides: Use the border-{x|y}-{color} utilities to set the border color on two sides of an element at the same time.
export default function BorderColor() {
  return (
    <div className="flex h-96 w-96 gap-4 border-8 border-pink-500 text-cyan-500">
      <div className="h-16 w-16 border-2 border-inherit"></div>
      <div className="h-16 w-16 border-2 border-current"></div>
    </div>
  );
}
