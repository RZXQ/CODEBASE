...
// Background Color: Utilities for controlling an element's background color.
// 1. Setting the background color: Control the background color of an element using the bg-{color} utilities.
// 2. Changing the opacity: Control the opacity of an element’s background color using the color opacity modifier. You can use any value defined in your opacity scale, or use arbitrary values if you need to deviate from your design tokens.

export default function BackgroundColor() {
  return <div className="bg-slate-200">div</div>;
}
