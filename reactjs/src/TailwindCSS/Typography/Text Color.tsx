...
//
// Text Color: Utilities for controlling the text color of an element.
// 1. Setting the text color: Control the text color of an element using the text-{color} utilities.
// 2. Changing the opacity: Control the opacity of an element’s text color using the color opacity modifier. You can use any value defined in your opacity scale, or use arbitrary values if you need to deviate from your design tokens.
export default function TextColor() {
  return (
    <p className="text-sky-400">The quick brown fox jumps over the lazy dog.</p>
  );
}
